        ...
        <h1 className="text-5xl font-extrabold tracking-tight sm:text-[5rem]">
          ...
          <div className="flex">
            ...
            <div className="ms-2 text-sm">
                <label htmlFor="helper-checkbox" className="font-medium text-gray-900 dark:text-gray-300">I agree to sell my soul</label>
                <p id="helper-checkbox-text" className="text-xs font-normal text-gray-500 dark:text-gray-300">20$ is 20$</p>
            </div>
